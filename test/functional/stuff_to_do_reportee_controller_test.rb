...
class StuffToDoReporteeControllerTest < ActionController::TestCase
  ...
  def test_add
    ...
    post :add, params: { user_id: 4, reportee_ids: [1] }
    ...
    initial_size = StuffToDoReportee.count
    post :add, params: { user_id: 4, reportee_ids: [5, 6] }
    assert_redirected_to controller: "stuff_to_do_reportee", action: "index", user_id: 4
  ...
  def test_delete
    @request.session[:user_id] = 4
    initial_size = StuffToDoReportee.count
    post :delete, params: { user_id: 4, reportee_id: 3 }
    assert_redirected_to controller: "stuff_to_do_reportee", action: "index", user_id: 4
    assert_equal initial_size - 1, StuffToDoReportee.count
  end
  ...
  def test_group
    ...
    post :add, params: { user_id: 4, group_ids: [Group.first.id] }
    assert_redirected_to controller: "stuff_to_do_reportee", action: "index", user_id: 4
    ...
    post :delete, params: { user_id: 4, group_id: Group.first.id}
    assert_redirected_to controller: "stuff_to_do_reportee", action: "index", user_id: 4
