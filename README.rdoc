...
1.1 for redmine1.x/rails2: Make sure the plugin is installed to +vendor/plugins/stuff_to_do_plugin+
1.1 for redmine2.x/rails3: Make sure the plugin is installed to +plugins/stuff_to_do_plugin+
2. Run the plugin migrations
2.1 for redmine1.x/rails2: +rake db:migrate_plugins+
2.1 for redmine2.x/rails3: +rake redmine:plugins:migrate+
